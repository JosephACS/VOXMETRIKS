...
<#
.SYNOPSIS
  Install local VOXMETRIKS dependencies (UTF-8 safe, no secrets printed).
#>
[CmdletBinding()]
param()
...
Write-Host "Next: .\scripts\start.ps1  (after .env + duckdb are ready)"
exit 0
