/** SVG icons registry — enterprise stroke icons (no emojis) */
...
export const ICONS: Record<string, string> = {
  ...
  playlist: svg('<line x1="8" y1="6" x2="21" y2="6"/><line x1="8" y1="12" x2="21" y2="12"/><line x1="8" y1="18" x2="21" y2="18"/><line x1="3" y1="6" x2="3.01" y2="6"/><line x1="3" y1="12" x2="3.01" y2="12"/><line x1="3" y1="18" x2="3.01" y2="18"/>'),
  ...
  dumbbell: svg('<path d="m6.5 6.5 11 11"/><path d="m21 3-3 3"/><path d="m3 21 3-3"/><path d="m18 6 3-3"/><path d="m6 18-3 3"/><path d="M14 10l-4 4"/>'),
  party: svg('<path d="M5.8 11.3 2 22l10.7-3.79"/><path d="M4 3h.01"/><path d="M22 8h.01"/><path d="M15 2h.01"/><path d="M22 20h.01"/><path d="m22 2-2 2"/><path d="M8 2l2 2"/><path d="M2 22l2-2"/>'),
  ...
  bronze: svg('<circle cx="12" cy="8" r="6"/><path d="M8 14h8l-1 8H9l-1-8z"/>', 20),
  silver: svg('<circle cx="12" cy="8" r="6"/><path d="M7 14h10l-1.5 8h-7L7 14z"/>', 20),
  gold: svg('<path d="M12 2l2.4 4.8 5.4.8-3.9 3.8.9 5.3L12 14.8 7.2 16.7l.9-5.3L4.2 7.6l5.4-.8L12 2z"/>', 20),
  ...
  album: svg('<rect x="3" y="3" width="18" height="18" rx="2"/><circle cx="8.5" cy="8.5" r="1.5"/><polyline points="21 15 16 10 5 21"/>'),
...
export function getIcon(key: string, _size = 18): string {
