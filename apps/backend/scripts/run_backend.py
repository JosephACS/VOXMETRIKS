# -*- coding: utf-8 -*-
"""Local VOXMETRIKS Uvicorn runner with file-based graceful shutdown.

Watches ``scripts/.runtime-pids/backend.shutdown.request`` (repo-relative) and sets
...
def shutdown_request_path() -> Path:
    return _repo_root() / "scripts" / ".runtime-pids" / _SHUTDOWN_REQUEST_NAME
