...
from app.packages.catalog.services.artist_service import (
    create_artist,
    delete_artist,
    get_artist_by_id,
    get_artist_stats,
...
from app.packages.identity.services.auth_deps import require_admin_user
...
from app.packages.catalog.services.cover_art_service import (
