...
MOOD_LABELS: Dict[str, Tuple[str, str]] = {
    "1_muy_baja": ("Relajado", "Muy baja energía · ambiente relajado"),
    "2_baja": ("Concentración", "Baja energía · enfoque moderado"),
    "3_media": ("Equilibrio", "Energía media equilibrada"),
    "4_alta": ("Entrenamiento", "Alta energía · actividad física"),
    "5_muy_alta": ("Fiesta", "Máxima intensidad · ambiente festivo"),
}
