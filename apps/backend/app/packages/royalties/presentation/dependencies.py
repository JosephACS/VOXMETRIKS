"""Royalty FastAPI dependencies — Spec 030.

Org-scoped RBAC via X-Organization-Id (billing pattern).
"""
...
def require_org_royalty_permission(permission_code: str):
    """Require org membership + royalty permission via X-Organization-Id."""
