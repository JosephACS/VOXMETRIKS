"""Artists FastAPI dependencies — Spec 020.
...
def require_org_artist_permission(permission_code: str):
    """Require org membership + artists permission via X-Organization-Id header.
    ...
    def _dep(
        ...
        if not perm_row:
            raise http_error(403, f"Missing artist permission: {permission_code}", code="permission_denied")
