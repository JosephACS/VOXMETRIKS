"""I1 auth smoke via FastAPI TestClient (conftest test DB pattern)."""
...
OUT = ROOT / "automation" / "specs" / "016-identity-and-organizations" / "evidence" / "_i1_auth_smoke.txt"
...
def main() -> int:
    # Mirror conftest env so app boots against isolated test DB
    ...
    # Import conftest helpers to init same test DB
