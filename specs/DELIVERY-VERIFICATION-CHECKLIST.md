...
| Quickstart único | ✅ | `README.md` → `docs/QUICKSTART.md` |
...
| `TRACEABILITY-COVERAGE-REPORT.md` | 2.0.0 | 001–011 | ✅ Actualizado |
| `DOCUMENT-COVERAGE-REPORT.md` | 2.0.0 | 001–011 (+ histórico 001–006) | ✅ Actualizado |
| `OPERATIVE-COMPLETENESS-AUDIT.md` | 2.0.0 | 001–011 | ✅ Actualizado |
| `OPERATIVE-GAP-ANALYSIS.md` | 1.0.0 | Histórico pre-008 | ⚠️ Archivado — ver banner |
| `SPEC-008-011-EVIDENCE-AUDIT.md` | 1.0.0 | Evidencia pre-spec | ✅ Referencia válida |
| `README.md` (raíz) | — | Entrada única | ✅ |
| `docs/QUICKSTART.md` | — | Arranque | ✅ |
| `specs/README.md` | — | Índice specs | ✅ |
| `.env.example` | — | Ruta DuckDB | ✅ `data/warehouse/voxmetrik.duckdb` |

### 3.1 Redirecciones huérfanas (no duplicar quickstart)

| Archivo | Estado esperado |
|---------|-----------------|
| `QUICKSTART.md` (raíz) | Redirige a `docs/QUICKSTART.md` |
| `backend/QUICKSTART.md` | Redirige a `docs/QUICKSTART.md` |
| `backend/README.md` | Redirige a raíz / quickstart |
| `backend/docs/SETUP.md` | Redirige a `docs/QUICKSTART.md` |
...
|---------|-----------|:----------:|
| `docs/uml/01-use-cases.puml` | CU por spec 001–011 | ✅ |
| `docs/uml/02-components.puml` | PKG-01…07 FE/BE | ✅ |
| `docs/uml/03-architecture.puml` | Docker, Medallion, volúmenes | ✅ |
| `docs/uml/04-elt-flow.puml` | CLI vs UI simulada + synthetic | ✅ |
