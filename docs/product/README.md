...
Documentación de negocio consolidada desde la Spec histórica **015** (cerrada con decisiones diferidas).
...
| [BUSINESS-RULES.md](BUSINESS-RULES.md) | Reglas transversales |
| [DEFERRED-DECISIONS.md](DEFERRED-DECISIONS.md) | Diferidos explícitos |

**Estado runtime:** [`../STATUS.md`](../STATUS.md)  
**Spec 015 histórica:** [`.specify/history/015-enterprise-business-foundation/spec.md`](../../.specify/history/015-enterprise-business-foundation/spec.md)
