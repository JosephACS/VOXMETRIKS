...
| 4 | Suscripciones personales / household | 029, 037; activa 052 | `personal_subscriptions` | Suscripciones implementadas; checkout profesional en consolidación | Pasarela real / precios finales diferidos |
...
| 8 | Suscripciones / billing / royalties | 018, 019, 030, 040; activa 052 | `subscriptions`, `billing`, `royalties` | Billing/subs implementados; checkout simulado profesional en consolidación; royalties **simulado/diferido** | Pasarela/payouts reales; **colisión histórica ID 030** |
...
- Feature activa: **052 Professional Subscription and Checkout Journey** — ver [`.specify/features/README.md`](features/README.md).
- Índice histórico: [`.specify/history/README.md`](history/README.md).
- Specs **050–051** están cerradas en history. **052** está activa; no crear otra Spec hasta su cierre.
