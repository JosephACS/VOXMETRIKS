...
- **Spec activa:** `054-permission-driven-product-navigation`. El siguiente ID disponible será `055` después de su cierre.

## Carpetas canónicas

| Ruta | Contenido |
|------|-----------|
| [`.specify/features/`](features/) | **Solo features activas** de implementación. Hoy: 054. |
| [`.specify/history/`](history/) | Specs **cerradas** o **reconstruidas** (001–053). |
